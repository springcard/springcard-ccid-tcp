...
#define OpenPortByName OpenNetworkByName
#define OpenPort OpenNetwork
#define ClosePort CloseNetwork
#define ReadPort ReadNetwork
#define WritePort WriteNetwork
